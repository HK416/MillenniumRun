...
/// #### 한국어 </br>
/// 텍스트 렌더링에 사용되는 유니폼 버퍼 구조체 입니다. </br>
/// 
/// #### English (Translation) </br>
/// This is a uniform buffer structure used for text rendering. </br>
/// 
#[repr(C, align(16))]
...
/// #### 한국어 </br>
/// 텍스트 렌더링에 사용되는 유니폼 버퍼 입니다. </br>
/// 
/// #### English (Translation) </br>
/// This is a uniform buffer used for text rendering. </br>
/// 
#[derive(Debug)]
...
impl UniformBuffer {
    pub fn new(device: &wgpu::Device, contents: &Uniform) -> Self {
