...
/// #### 한국어 </br>
/// `DisplayNotify` 상태의 지속 시간입니다. </br>
/// 
/// #### English (Translation) </br>
/// Duration of the `DisplayNotify` state. </br>
/// 
...
/// #### 한국어 </br>
/// `intro` 게임 장면의 `DisplayNotify` 상태일 때 업데이트 함수입니다. </br>
/// 
/// #### English (Translation) </br>
/// This is an update function when the `intro` game scene is in the `DisplayNotify` state. </br>
/// 
...
/// #### 한국어 </br>
/// `intro` 게임 장면의 `DisplayNotify` 상태일 때 그리기 함수 입니다. </br>
/// 
/// #### English (Translation) </br>
/// This is a drawing function when the `intro` game scene is in the `DisplayNotify` state. </br>
/// 
pub fn draw(this: &IntroScene, shared: &mut Shared) -> AppResult<()> {
    ...
    let mut encoder = device.create_command_encoder(&wgpu::CommandEncoderDescriptor::default());
    {
        let mut rpass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
            label: Some("RenderPass(IntroScene(DisplayNotify(Ui)))"),
