...
/// #### 한국어 </br>
/// `FadeIn` 상태의 지속 시간입니다. </br>
/// 
/// #### English (Translation) </br>
/// Duration of the `FadeIn` state. </br>
/// 
...
/// #### 한국어 </br>
/// `intro` 게임 장면의 `FadeIn` 상태일 때 업데이트 함수입니다. </br>
/// 
/// #### English (Translation) </br>
...
/// #### 한국어 </br>
/// `intro` 게임 장면의 `FadeIn` 상태일 때 그리기 함수 입니다. </br>
/// 
/// #### English (Translation) </br>
/// This is a drawing function when the `intro` game scene is in the `FadeIn` state. </br>
/// 
